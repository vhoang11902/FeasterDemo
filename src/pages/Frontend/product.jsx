  ...
  return (
    <div className="max-w-[1600px]  mx-0 my-[auto]">
      ...
      <div className="max-w-full">
        <div className="border-y-[1px] flex justify-center uppercase">
          <div
            className={`mx-10 cursor-pointer hover:border-b-[4px] hover:border-black flex items-center h-[50px] `}
        ...
        <div className="flex flex-row">
          <div className="w-[70%] h-full py-[10px]">
              ...
              <div className=" px-[35px] pt-[24px]">
                <div className="mb-[24px]">
                  ...
                  <div className="text-[14px] font-thin">
                    ...
                    Freedom floating bed base. It’s set atop dainty yet strong
                    feet that create an illusion of floating. This ensemble base
                    is wrapped in a fabric upholstery that enhances its
                    simplicity and makes maintenance easy. The upholstery is in
                    taupe, a neutral colour that seamlessly blends with most
                    colour palettes. This is the perfect addition to bedrooms
                    and sparerooms - simply add your mattress and you are ready
                    to sleep.
                  </div>
                </div>
                <div className="mb-[24px]">
                  ...
                  <div className="font-thin text-[14px]">
                    ...
                    <li>Australian made and backed by a 10-year warranty</li>
              ...
              <div className=" px-[35px] pt-[24px]">
                <div className="mb-[24px]">
                  ...
                  <div className="font-thin">
                    ...
                    <li>
                      Periodically check all hardware and bolt connections are
                      tight
                    </li>
                  </div>
                </div>
          ...
          <div className="w-[30%] mr-10 pt-6">
            <div className="bg-[#f9f9f9] rounded-md">
              ...
              <div className="relative mb-2 py-[13px] pr-[17px] pl-[56px]">
                <h4 className="text-[18px] font-semibold">Have a question?</h4>
                <div className="font-thin text-sm">
                  If you would like to know more we would love to help. Visit
                  our contact-us page or speak with a Live Chat team member now
                </div>
              </div>
            </div>
          </div>
